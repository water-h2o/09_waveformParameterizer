...
void PFsansCategories(stringvec v,
	...
	outf_sansCategories.open("./resources/output/FF_sansCategories.txt",
...
sTree3D getCategorizationFileNames(){
	...
	// 1 peaks
	N1pks.push_back("./resources/output/F_Nbrem_1pk_0plt.txt"); // 0 plt
	N1pks.push_back("./resources/output/F_Nbrem_1pk_1plt.txt"); // 1 plt
	
	for(int i=2; i<9; i++) N1pks.push_back("N/A");            // 2-8 plt
	
	N1pks.push_back("./resources/output/F_Nbrem_1pk_Mplt.txt"); // 9 plt
	
	// 2 peaks
	N2pks.push_back("./resources/output/F_Nbrem_2pk_0plt.txt"); // 0 plt
	N2pks.push_back("./resources/output/F_Nbrem_2pk_1plt.txt"); // 1 plt
	
	for(int i=2; i<9; i++) N2pks.push_back("N/A");            // 2-8 plt
	
	N2pks.push_back("./resources/output/F_Nbrem_2pk_Mplt.txt"); // 9 plt
	
	// 3-8 peaks
	//nothing
	
	// 9 (the nine is used to represent "many") peaks
	NMpks.push_back("./resources/output/F_Nbrem_Mpk_0plt.txt"); // 0 plt
	NMpks.push_back("./resources/output/F_Nbrem_Mpk_1plt.txt"); // 1 plt
	
	for(int i=2; i<9; i++) NMpks.push_back("N/A");            // 2-8 plt
	
	NMpks.push_back("./resources/output/F_Nbrem_Mpk_Mplt.txt"); // 9 plt
	...
	// 1 peaks
	Y1pks.push_back("./resources/output/F_Ybrem_1pk_0plt.txt"); // 0 plt
	Y1pks.push_back("./resources/output/F_Ybrem_1pk_1plt.txt"); // 1 plt
	
	for(int i=2; i<9; i++) Y1pks.push_back("N/A");            // 2-8 plt
	
	Y1pks.push_back("./resources/output/F_Ybrem_1pk_Mplt.txt"); // 9 plt
	
	// 2 peaks
	Y2pks.push_back("./resources/output/F_Ybrem_2pk_0plt.txt"); // 0 plt
	Y2pks.push_back("./resources/output/F_Ybrem_2pk_1plt.txt"); // 1 plt
	
	for(int i=2; i<9; i++) Y2pks.push_back("N/A");            // 2-8 plt
	
	Y2pks.push_back("./resources/output/F_Ybrem_2pk_Mplt.txt"); // 9 plt
	
	// 3-8 peaks
	// nothing
	
	// 9 peaks
	YMpks.push_back("./resources/output/F_Ybrem_Mpk_0plt.txt"); // 0 plt
	YMpks.push_back("./resources/output/F_Ybrem_Mpk_1plt.txt"); // 1 plt
	
	for(int i=2; i<9; i++) YMpks.push_back("N/A");            // 2-8 plt
	
	YMpks.push_back("./resources/output/F_Ybrem_Mpk_Mplt.txt"); // 9 plt
