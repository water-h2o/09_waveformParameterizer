...
a_sentence a_Features2a_sentence_hasCat(a_Features In){
	...
	head_idx += 2;
	*/ // YOU'VE BEEN HAD BY THE ALL FEATURES ON EVERYTHING GANG. SEMPER FI
	
	out.push_back(std::to_string(In.signalPeakHeights[0]));
	out.push_back(std::to_string(In.signalPeakHeights[1]));
	out.push_back(std::to_string(In.signalPeakHeights[2]));
	out.push_back(std::to_string(In.signalMaxPeakHeight));
	out.push_back(std::to_string(In.signalPeakTimes_after5[0]));
	out.push_back(std::to_string(In.signalPeakTimes_after5[1]));
	out.push_back(std::to_string(In.signalPeakTimes_after5[2]));
	out.push_back(std::to_string(In.signalMaxPeakTime_after5));
	head_idx += 8;
	
	out.push_back(std::to_string(In.signalPlateauHeights[0]));
	out.push_back(std::to_string(In.signalPlateauHeights[1]));
	out.push_back(std::to_string(In.signalMaxPlateauHeight));
	out.push_back(std::to_string(In.signalPlateauTimes_after5[0]));
	out.push_back(std::to_string(In.signalPlateauTimes_after5[1]));
